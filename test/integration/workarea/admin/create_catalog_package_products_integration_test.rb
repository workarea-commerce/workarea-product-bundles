...
module Workarea
  module Admin
    class CreateCatalogPackageProductsIntegrationTest < Workarea::IntegrationTest
      include Admin::IntegrationTest

      def test_create
        post admin.create_catalog_package_products_path,
             params: {
               product: {
                 name: 'Test Product',
                 slug: 'foo-bar',
      ...
      def test_save_images
        ...
        post admin.save_images_create_catalog_package_product_path(product),
             params: {
      ...
      def test_save_details
        ...
        post admin.save_details_create_catalog_package_product_path(product),
             params: {
               filters: %w(Color Red),
      ...
      def test_save_content
        ...
        post admin.save_content_create_catalog_package_product_path(product),
      ...
      def test_save_categorization
        ...
        post admin.save_categorization_create_catalog_package_product_path(product),
      ...
      def test_publish
        ...
        get admin.publish_create_catalog_package_product_path(product)
      ...
      def test_save_publish
        ...
        post admin.save_publish_create_catalog_package_product_path(product),
             params: { activate: 'now' }
